...
| 编号 | 标题 | 状态 | 严重程度 | 模块 | 文档 |
| --- | --- | --- | --- | --- | --- |
| BUG-0025 | ccswitch 新增 OpenAI 兼容供应商单选请求 usage 不再无目标账户 | 已修复（新增回归） | P1 | 后端 / 网关 / 使用记录 / OpenAI-compatible provider | [问题-0025-ccswitch新增OpenAI兼容供应商单选请求usage不再无目标账户.md](问题-0025-ccswitch新增OpenAI兼容供应商单选请求usage不再无目标账户.md) |
