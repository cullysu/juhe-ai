...
export function findOpenAIAccountForGroup(
  ...
  const row = getBusinessDatabase()
    ...
    `)
    .get(accountId, groupAccess.providerCode, groupAccess.providerProtocolProfileId, groupAccess.providerCode, groupAccess.providerProtocolProfileId, now) as unknown as OpenAIAccountRow | undefined
  if (!row) {
    return undefined
  }
